...
class NavigatorWithInterceptor {
  ...
  static Future<T?> pushNamed<T extends Object?>(
    ...
    return Navigator.of(context).pushNamedWithInterceptor<T>(
      routeName,
      arguments: arguments,
    );
  }
  ...
  /// {@end-tool}
  @optionalTypeArgs
  static Future<String> restorablePushNamed<T extends Object?>(
    BuildContext context,
    String routeName, {
    Object? arguments,
  }) async {
    return Navigator.of(context).restorablePushNamedWithInterceptor<T>(
      routeName,
      arguments: arguments,
    );
  }
  ...
  static Future<T?> pushReplacementNamed<T extends Object?, TO extends Object?>(
    ...
    return Navigator.of(context).pushReplacementNamedWithInterceptor<T, TO>(
      routeName,
      arguments: arguments,
      result: result,
    );
  ...
  static Future<String>
    ...
    return Navigator.of(context)
        .restorablePushReplacementNamedWithInterceptor<T, TO>(
      routeName,
      arguments: arguments,
      result: result,
    );
  ...
  static Future<T?> popAndPushNamed<T extends Object?, TO extends Object?>(
    ...
    return Navigator.of(context).popAndPushNamedWithInterceptor<T, TO>(
      routeName,
      arguments: arguments,
      result: result,
    );
  ...
  static Future<String>
    ...
    return Navigator.of(context)
        .restorablePopAndPushNamedWithInterceptor<T, TO>(
      routeName,
      arguments: arguments,
      result: result,
    );
  ...
  static Future<T?> pushNamedAndRemoveUntil<T extends Object?>(
    ...
    return Navigator.of(context).pushNamedAndRemoveUntilWithInterceptor<T>(
      newRouteName,
      predicate,
      arguments: arguments,
    );
  ...
  /// {@end-tool}
  @optionalTypeArgs
  static Future<String> restorablePushNamedAndRemoveUntil<T extends Object?>(
    BuildContext context,
    String newRouteName,
    RoutePredicate predicate, {
    Object? arguments,
    ...
    return Navigator.of(context)
        .restorablePushNamedAndRemoveUntilWithInterceptor<T>(
      newRouteName,
      predicate,
      arguments: arguments,
    );
